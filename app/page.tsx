...
export default function Home() {
  return (
    <div className="flex-1 flex flex-col space-y-40 my-20 mx-auto">
      ...
      {/* Benefits Section */}
      <div className='flex flex-col-reverse sm:flex-row mx-8 gap-6 justify-evenly items-center'>
        <ul className="space-y-2 text-md sm:text-lg font-[Inter] font-light list-disc">
