export default function ResearchPage() {
    return (
        <div className="mx-auto p-4 mt-20 space-y-8 font-[Space_Grotesk] text-[#F2F2F0]">
            <h1 className="text-center text-6xl md:text-7xl bg-linear-[60deg,#E420B3,#FF2D55,#F0662A,#F2C521] bg-clip-text text-transparent">
                Coming soon
            </h1>
